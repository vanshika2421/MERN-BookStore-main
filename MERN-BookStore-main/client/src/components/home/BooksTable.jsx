          ...
          <tbody>
            {books.map((book, index) => (
              <tr key={book._id}>
                ...
                <td className='border text-black-500 px-4 py-2'>{book.title}</td>
                <td className='border text-black-500 px-4 py-2 max-md:hidden'>{book.genre}</td>
                <td className='border text-black-500 px-4 py-2 max-md:hidden'>{book.author}</td>
                <td className='border text-black-500 px-4 py-2'>{book.year}</td>
                <td className='border text-black-500 px-4 py-2 max-md:hidden'>{book.pages}</td>
                <td className='border text-black-500 px-4 py-2 max-md:hidden'>{book.publisher}</td>
                <td className='border text-black-500 px-4 py-2'>
